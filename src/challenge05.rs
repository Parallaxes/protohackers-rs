...
//         while upstream_buf.read_line(&mut line).await.expect("Failed to read line") != 0 {
//             let modified = line
//                 .split_whitespace()
//                 .map(|word| {
//                     if regex1.is_match(word) {
//                         TONY_ADDRESS
//                     } else {
//                         word
//                     }
...
//             if client_writer.write_all(modified.as_bytes()).await.is_err() {
//                 break;
//             }
//             line.clear();
//         }
...
//         let mut line = String::new();
//         while client_buf.read_line(&mut line).await.expect("Failed to read line") != 0 {
//             let modified = line
//                 .split_whitespace()
//                 .map(|word| {
//                     if regex2.is_match(word) {
//                         TONY_ADDRESS
//                     } else {
//                         word
//                     }
...
//             println!("--> {}", line);
//             println!(" Modified: {}", modified);
//             if upstream_writer.write_all(modified.as_bytes()).await.is_err() {
//                 break;
//             }
//             line.clear();
//         }
